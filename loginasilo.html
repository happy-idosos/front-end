...
<head>
    ...
    <link rel="stylesheet" href="css/style-loginasilo.css">
</head>
<body>  
    ...
    <div class="container">
        ...
        <div class="form-container">
            <form id="loginForm" class="login-form">
                <div class="form-section">
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" placeholder="Digite o e-mail da instituição" required>
                    </div>
            ...
            <div class="register-link">
                <!-- Updated registration link to point to nursing home registration -->
                <p>Não tem conta? <a href="cadastroasilo.html" class="link">Cadastre sua instituição aqui</a></p>
            </div>
        </div>
    </div>
            ...
            async function handleFormSubmit(e) {
                ...
                try {
                    ...
                    setTimeout(() => {
                        ...
                        window.location.href = "dashboard-asilo.html"
                    }, 1500)
