...
<head>
    ...
    <title>Contato - Happy Idosos</title>
...
<body>
    <header>
        <!-- Header transparente EXATAMENTE igual ao index -->
    ...
    <!-- Carrossel EXATAMENTE igual ao index, mas com conteúdo de contato -->
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block">
                    ...
                    <a href="#contato-form" class="btn btn-secondary">Fale Conosco</a>
                    <a href="asilos.html" class="btn btn-outline-light">Buscar Asilos</a>
                </div>
            </div>
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block">
                    ...
                    <a href="#contato-form" class="btn btn-secondary">Fale Conosco</a>
                    <a href="index.html" class="btn btn-outline-light">Página Inicial</a>
                </div>
            </div>
        </div>
    ...
    <main>
        <!-- Seção de contato simples inspirada na imagem fornecida -->
        <section class="contato-section py-5" id="contato-form" data-aos="fade-up" data-aos-duration="800">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-6">
                        <div class="contato-header text-center mb-5">
                            <div class="contato-badge">
                                <span>CONTATO</span>
                            </div>
                            <h2 class="mt-4">Faça seu registro abaixo e entraremos em contato</h2>
                        </div>
                        
                        <div class="contato-form-container">
                            <form class="contato-form" data-aos="fade-up" data-aos-delay="200">
    ...
    <!-- Scripts AOS e scroll navbar iguais ao index -->
    <script>
        AOS.init({
            duration: 800,
            easing: 'ease-in-out',
